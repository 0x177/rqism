...
impl QuantumState {
    ...
    fn gate_apply_sq(&self,t: &Array2<Complex<f32>>,i: usize) -> Self {
	Self {
	    n: self.n,
    ...
    fn gate_apply_nq(&self, t: &Array2::<Complex<f32>>, i: &[usize]) -> Self {
